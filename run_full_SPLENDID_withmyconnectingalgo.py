...
def run_full_desert_inference(model_path, shape_patches_path, device='cuda', max_length=50, use_zero_memory=False):
...
def main():
    ...
    try:
        ...
        generated_sequences = run_full_desert_inference(
