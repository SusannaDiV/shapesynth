...
def main():
    ...
    # Save fingerprints
    save_pharmacophore_fingerprints("aspirin", overall_grid1, feature_grids1, feature_atoms1, grid_info1)
    save_pharmacophore_fingerprints("ibuprofen", overall_grid2, feature_grids2, feature_atoms2, grid_info2)
    
    # Visualize individual fingerprints
    visualize_pharmacophore_fingerprints(mol1, overall_grid1, feature_grids1, grid_info1, "aspirin_pharmacophore.html")
    visualize_pharmacophore_fingerprints(mol2, overall_grid2, feature_grids2, grid_info2, "ibuprofen_pharmacophore.html")
    
    # Align grids before blending
    ...
    print("\nFingerprint blending complete.")
    print("These blended fingerprints can now be used to guide the construction of a child molecule.")
