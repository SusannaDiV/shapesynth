...
if __name__ == "__main__":
    ...
    while True:
        ...
        # STEP 3.1: DOCKING-GUIDED CROSSOVER
        print("\nPerforming docking-guided crossover...")
        ...
        for i in range(config["offspring_size"]):
            ...
            child = reproduce(
                ...
                center,
                box_size,
                {}  # Empty dict since pharmacophore_info is unused
            )
        ...
        save_population_results(new_synformer_results, f"{args.synformer_checkpoint}.gen{generation}")
        ...
        for mol in population_mol:
            ...
            found = False
            for result in new_synformer_results:
