...
if __name__ == "__main__":
    ...
    encoder = create_fragment_encoder(vocab_path=vocab_path, device='cpu', mixture_weight=0.6) # Corrected comment: mixture_weight is 0.6
    ...
    # max_steps_exp1 = 10 
    # num_generations_per_latent = 5 # Number of molecules to generate per latent vector
    ...
    pass # Add a pass statement if the removed code was the last thing in the block
