...
class Synformer(nn.Module):
    ...
    def encode(self, batch, mixture_weight: float | None = None):
        ...
        if hasattr(self, 'encoder_type') and self.encoder_type == "desert":
            ...
            current_mixture_weight = mixture_weight if mixture_weight is not None else 1.0 # default to 0.8 if not provided
            ...
            encoder = create_fragment_encoder(
                ...
                grid_resolution=0.5, 
                max_dist=6.75,        
                mixture_weight=current_mixture_weight 
            )
    ...
    def load_pretrained_decoder(self, smiles_checkpoint_path, device='cuda'):
        ...
        pretrained_decoder = Decoder(
            ...
            num_layers=decoder_params.get('num_layers', 10),  
            pe_max_len=decoder_params.get('pe_max_len', 32),  
            output_norm=False,  
