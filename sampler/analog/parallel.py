...
class Worker(mp.Process):
    def __init__(
        ...
        self._no_adapter = no_adapter
        self._minimal_processing = minimal_processing
    ...
    def run(self) -> None:
        ...
        if self._use_desert:
            ...
            config.model.no_adapter = self._no_adapter
            config.model.minimal_processing = self._minimal_processing
...
def run_parallel_sampling(
    ...
    initial_desert_mixture_weight: float = 1,
    retry_desert_mixture_weight: float = 0.5,
) -> None:
...
def run_sampling_one_cpu(
    ...
    if use_desert:
        ...
        config.model.no_adapter = no_adapter
