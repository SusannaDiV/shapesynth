...
def run_desert_inference(smiles, model_path, shape_patches_path=None, device='cuda', max_length=50):
    ...
    # Get shape patches
    if shape_patches_path is None:
        # Use default path if none provided
        shape_patches_path = '/home/luost_local/sdivita/synformer/data/desert/sample_shapes/4f45_A_shapes.pkl'
...
def main():
    ...
    parser.add_argument('--shape_patches_path', type=str,
                        default="/home/luost_local/sdivita/synformer/data/desert/sample_shapes/4f45_A_shapes.pkl",
                        help='Path to the shape patches file')
    ...
    try:
        ...
        outputs = run_desert_inference(args.smiles, args.model_path, args.shape_patches_path)
